...
namespace gltools{
    enum {
        ...
        BLUE_DARK2, RED_DARK2, GREEN_DARK2, Grey_dark2
    };
};
...
//Text utilities
	static void Print(string msg, float x=0, float y=0,float z=0,int fuente=1);				//font type {1-3} HELVETIA// tipo de letra si añadimos texto
